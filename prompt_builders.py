...
{{
  ...
  "thumbnail_prompt": "WHY SCENE THUMBNAIL - MAXIMIZE CTR: The thumbnail must function as a WHY scene that creates curiosity and makes viewers NEED to watch. Visually frame a MYSTERY, PROBLEM, QUESTION, or SECRET that the video will reveal. Show counterintuitive elements, hidden truths, or something unexpected. Use visual storytelling to create curiosity gaps. Composition: intense close-ups, dramatic expressions showing realization/shock/conflict, extreme lighting (chiaroscuro), bold colors (red/yellow for urgency/danger), symbolic elements that suggest hidden meaning or secrets. Subject in MOMENT OF DISCOVERY or CONFRONTATION - not passive. Show visual hints of the mystery/problem/secret without revealing the answer. Think: 'What question does this image make me ask?' The viewer should look at this and think 'I NEED to know what this is about' - create visual curiosity gaps. NO TEXT in image, but visually SCREAM mystery, urgency, and the promise of revelation. Optimized for mobile scrolling - must instantly create curiosity when tiny in feed.",
...
Generate JSON:
{{
  "title": "SCARY CLICKBAIT YouTube title (60-80 chars). Use horror power words like: TERRIFYING, HAUNTED, POSSESSED, CURSED, EVIL, DEMONIC, NIGHTMARE, HORROR, SCARY, CREEPY, DISTURBING, UNSETTLING, CHILLING. Create fear and curiosity. Examples: 'The TERRIFYING Truth About This House', 'I Found Something EVIL in My Basement', 'This NIGHTMARE Still Haunts Me', 'The CURSED Object That Changed Everything', 'I Should Have NEVER Gone There'. Must be engaging and make viewers NEED to watch while staying appropriate.",
  ...
  "thumbnail_description": "WHY SCENE THUMBNAIL - MAXIMIZE CTR THROUGH HORROR: The thumbnail must function as a WHY scene that creates fear and curiosity. Visually frame a MYSTERY, THREAT, or HORROR ELEMENT that makes viewers NEED to watch. Show scary, unsettling, or creepy elements. Use visual storytelling to ask: 'What horror is this?', 'What threat is here?', 'What will happen?', 'What is watching?'. Composition: intense close-ups, fearful expressions, dramatic shadows, eerie lighting, horror atmosphere, symbolic elements suggesting danger or horror, visual curiosity gaps that make viewers ask 'What is this about?'. Subject in MOMENT OF FEAR, DISCOVERY, or CONFRONTATION with horror - not passive. Show visual hints of the horror/threat without fully revealing it. Think: 'What question does this image make me ask?' The viewer should look at this and think 'I NEED to know what this horror is about' - create visual fear and curiosity gaps. NO TEXT in image, but visually SCREAM horror, fear, and the promise of scares.",
