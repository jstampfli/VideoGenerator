...
Generate JSON:
{{
  "title": "WHY SCENE PARADIGM TITLE - MAXIMIZE CTR (60-80 chars): The title must function as a WHY scene that creates curiosity and makes viewers NEED to click. Frame a MYSTERY, PROBLEM, QUESTION, SECRET, or COUNTERINTUITIVE element about {subject_of_interest} that the video will reveal. Use power words: SHOCKING, SECRET, REVEALED, EXPOSED, DARK, UNTOLD, UNBELIEVABLE, INCREDIBLE, INSANE, CRAZY, MIND-BLOWING, FORBIDDEN, HIDDEN, IMPOSSIBLE. Create CURIOSITY GAPS - ask questions, hint at secrets, suggest something unexpected. The title should make viewers think: 'What secret is this?', 'How did this happen?', 'What problem is being solved?', 'What mystery will be revealed?'. Examples following WHY paradigm: 'The SHOCKING Secret {subject_of_interest} Kept Hidden', 'How {subject_of_interest} Did the IMPOSSIBLE (You Won't Believe How)', 'The Dark Truth They DON'T Want You to Know About {subject_of_interest}', '{subject_of_interest}: The Forbidden Discovery That Changed Everything', 'This ONE Decision Changed Runeterra FOREVER (Here's Why)', 'The Secret {subject_of_interest} Took to the Grave', 'What Nobody Knows About {subject_of_interest}'s Greatest Power'. Must create a curiosity gap that makes viewers NEED to click to get the answer, while staying accurate to LoL lore.",
  ...
  "thumbnail_description": "WHY SCENE THUMBNAIL - MAXIMIZE CTR (MUST BE COHESIVE WITH TITLE): The thumbnail must function as a WHY scene that creates the SAME curiosity gap as the title. Visually frame the SAME MYSTERY, PROBLEM, QUESTION, or SECRET that the title frames. If the title asks 'What secret?', the thumbnail should visually hint at that secret. If the title asks 'How did this happen?', the thumbnail should show the moment of discovery or the problem. If the title mentions 'The Dark Truth', the thumbnail should show visual elements suggesting hidden truth or revelation. If the title mentions 'The Forbidden Discovery', the thumbnail should show visual elements suggesting discovery or forbidden knowledge. Show counterintuitive elements, hidden truths, or something unexpected that matches the title's curiosity gap. Use visual storytelling to ask the SAME questions the title asks: 'What secret is this?', 'How did this happen?', 'What problem is being solved?', 'What mystery will be revealed?'. Composition: intense close-ups, dramatic expressions showing realization/shock/conflict, extreme lighting (chiaroscuro), bold colors (red/yellow for danger/urgency), powerful symbols, emotional moments matching the title's theme. Show conflict, tension, or peak dramatic moment. Subject should appear in a MOMENT OF DISCOVERY, CONFRONTATION, or IMPACT - not calm portrait. Think action movie poster, not museum painting. Include fantasy/magical elements appropriate for League of Legends lore. Use high contrast, dramatic shadows, cinematic lighting. Think: 'What question does this image make me ask?' It should be the SAME question the title asks. NO TEXT in image, but visually SCREAM importance, mystery, urgency, and the promise of revelation that matches the title's promise.",
...
CRITICAL: TITLE AND THUMBNAIL MUST BE COHESIVE AND SYNCED - They must create the SAME curiosity gap and work together to maximize CTR. The thumbnail should visually represent the same mystery/question/ranking surprise that the title frames.

Generate JSON:
{{
  "title": "WHY SCENE PARADIGM TITLE - MAXIMIZE CTR (60-80 chars) for a top {num_entries} list about: {topic}: The title must function as a WHY scene that creates curiosity and makes viewers NEED to click. Frame a MYSTERY, QUESTION, or SECRET about the ranking that the video will reveal. Use power words: TOP {num_entries}, RANKED, SHOCKING, REVEALED, UNBELIEVABLE, IMPOSSIBLE, FORBIDDEN, HIDDEN. Create CURIOSITY GAPS - ask questions, hint at surprises, suggest unexpected rankings. The title should make viewers think: 'Who/what is #1?', 'What will surprise me?', 'What secret ranking is this?', 'What unexpected entry made the list?'. Examples following WHY paradigm: 'TOP {num_entries} {topic} RANKED (You Won't Believe #1)', 'The SHOCKING Truth About the Most Powerful {topic} (Wait Until You See #1)', 'TOP {num_entries} {topic} - The Ranking That Changed Everything', 'The Forbidden {num_entries} - What They DON'T Want You to Know', 'TOP {num_entries} {topic} (The #1 Will Shock You)'. Adapt to the topic - if it's about events use 'MOST IMPORTANT EVENTS', if it's about power use 'MOST POWERFUL', if it's about champions use 'BEST CHAMPIONS', etc. Must create a curiosity gap that makes viewers NEED to click to see the full ranking.",
  ...
  "thumbnail_description": "WHY SCENE THUMBNAIL - MAXIMIZE CTR (MUST BE COHESIVE WITH TITLE) for a top {num_entries} list about: {topic}: The thumbnail must function as a WHY scene that creates the SAME curiosity gap as the title. Visually frame the SAME MYSTERY, QUESTION, or SECRET about the ranking that the title frames. If the title asks 'Who/what is #1?', the thumbnail should visually hint at the #1 entry or create mystery around it. If the title mentions 'You Won't Believe #1', the thumbnail should show visual elements suggesting surprise or unexpected power. If the title mentions 'The Ranking That Changed Everything', the thumbnail should show visual elements suggesting impact or transformation. Use dramatic composition showing relevant elements (characters, events, locations, etc. depending on topic) that match the title's curiosity gap. Show cosmic/magical scale, extreme lighting (chiaroscuro), bold colors (reds/yellows for urgency), symbolic elements representing the ranking and the mystery the title frames. Show epic scale. Think epic fantasy movie poster. Include fantasy/magical elements appropriate for League of Legends lore. Think: 'What question does this image make me ask?' It should be the SAME question the title asks. NO TEXT in image, but visually SCREAM importance, epic scale, and the promise of ranking revelation that matches the title's promise.",
